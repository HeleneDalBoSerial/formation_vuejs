<template>
  <v-container>
    <v-row>
      <v-col sm="12" md="6">
        <v-btn block @click="btnClicked">{{
          $t('click_here', { name: 'Hélène' })
        }}</v-btn>
      </v-col>
      <v-col sm="12" md="6">
    ...
    <v-row justify="space-between">
      ...
      <v-col sm="12" md="3">
        <v-text-field :label="$t('email')"></v-text-field>
      </v-col>
    </v-row>
    <v-row justify="space-around">
      <v-col sm="12" md="3">
        <v-text-field :label="$t('phone')"></v-text-field>
      </v-col>
      <v-col sm="12" md="3">
        <v-text-field :label="$t('age')"></v-text-field>
      </v-col>
    </v-row>
